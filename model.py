...
def get_model(input_shape=(48, 32, 1), output_category_number=11):
    ...
    conv1Alternative1_preAct = Conv2D(32, 3, padding='same', kernel_initializer='he_normal')(conv1)
    bn2 = BatchNormalization()(conv1Alternative1_preAct)
    conv1Alternative1 = Activation('relu')(bn2)


    conv1Alternative2_preAct = Conv2D(32, 3, padding='same', kernel_initializer='he_normal')(conv1Alternative1)
    ...
    conv2_preAct = Conv2D(64, 3, padding='same', kernel_initializer='he_normal')(pool1BranchesAdd)
    bn4 = BatchNormalization()(conv2_preAct)
    conv2 = Activation('relu')(bn4)

    pool2 = MaxPooling2D(pool_size=(2, 2))(conv2)

    conv2Alternative1_preAct = Conv2D(64, 3, padding='same', kernel_initializer='he_normal')(conv2)
    ...
    dense1_preAct = Dense(64, kernel_initializer='he_normal')(flat)
    bn7 = BatchNormalization()(dense1_preAct)
    dense1 = Activation('relu')(bn7)

    dense2_preAct = Dense(32, kernel_initializer='he_normal')(dense1)
    bn8 = BatchNormalization()(dense2_preAct)
    dense2 = Activation('relu')(bn8)

    out = Dense(output_category_number, activation='softmax')(dense2)
